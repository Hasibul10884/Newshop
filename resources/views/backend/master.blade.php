...
<head>
    ...
    <!-- morris CSS -->
    <link href="{{url('backend/assets/plugins/morrisjs/morris.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    @include('backend.fixed.header')
        ...
        @include('backend.fixed.right-sidebar')
    ...
    <script src="{{url('backend/assets/plugins/sparkline/jquery.sparkline.min.js')}}"></script>
    <!--morris JavaScript -->
    <script src="{{url('backend/assets/plugins/raphael/raphael-min.js')}}"></script>
    <script src="{{url('backend/assets/plugins/morrisjs/morris.min.js')}}"></script>
    <!-- Chart JS -->
